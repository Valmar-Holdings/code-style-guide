    ...
    >
        ...
        >
            ...
            >
                ...
                <div class="flex my-10">
                    ...
                    <a
                        href="https://jigsaw.tighten.co"
                        title="Jigsaw by Tighten"
                        class="px-6 py-2 font-normal text-blue-900 bg-gray-400 rounded hover:bg-gray-600 hover:text-white"
                    >About Jigsaw</a>
                </div>
            </div>
        ...
        <div class="-mx-2 -mx-4 md:flex">
            <div class="px-2 mx-3 mb-8 md:w-1/3">
                <img
                    src="{{ url('/assets/img/icon-window.svg') }}"
                    class="w-12 h-12"
                    alt="window icon"
                >
                ...
                <h3
                    id="intro-laravel"
                    class="mb-0 text-2xl text-blue-900"
                >Templating with <br>Laravel's Blade engine</h3>
            ...
            <div class="px-2 mx-3 mb-8 md:w-1/3">
                <img
                    src="{{ url('/assets/img/icon-terminal.svg') }}"
                    class="w-12 h-12"
                    alt="terminal icon"
                >
                ...
                <h3
                    id="intro-markdown"
                    class="mb-0 text-2xl text-blue-900"
                >Use Markdown for <br>content-driven pages</h3>
            ...
            <div class="px-2 mx-3 md:w-1/3">
                <img
                    src="{{ url('/assets/img/icon-stack.svg') }}"
                    class="w-12 h-12"
                    alt="stack icon"
                >
                ...
                <h3
                    id="intro-mix"
                    class="mb-0 text-2xl text-blue-900"
                >Compile your assets <br>using Laravel Mix </h3>
